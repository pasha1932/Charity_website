...
export const CONTENT_CONNECTS = [
  { title: '@info.foreveryone.team. ua@gmail.com', img: img1},
  { title: '+380688344675', img: img2},
  { title: '79000, УКРАЇНА, ОБЛ. ЛЬВІВСЬКА, Р-Н. ЛЬВІВСЬКИЙ, С. ВЕЛИКІ ПІДЛІСКИ, ВУЛ. НЕЗАЛЕЖНОСТІ, Б. 148', img: img3, },
]